...
"""
Module for controlling the Red Pitaya lockbox 'rp-lockbox' via SCPI commands sent/receveived through
TCP/IP socket.
See:
https://github.com/lmaisenbacher/rp-lockbox
"""
...
class RPLockbox(dev_generic.Device):
    ...
    def __init__(self, device):
        ...
        self.device['SCPIConnectionParams'] = {
            **self.default_scpi_connection_params,
            **self.device.get('SCPIConnectionParams', {})
            }
